...
# name exactly four application-directory entries: mise's own bin (needed
# before activation can run at all), nvim's and bac's (both built from source,
# neither ever resolved as a mise tool - BAC-R-13), and codium's, which holds
# the generated Flatpak launcher (APPS-R-12) and is likewise never a mise tool.
